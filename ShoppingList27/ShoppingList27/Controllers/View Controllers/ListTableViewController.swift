...
class ListTableViewController: UITableViewController {
    ...
    func presentNewItemAlert() {
        ...
        let saveAction = UIAlertAction(title: "Save", style: .default) { action in
            ...
            ListController.sharedInstance.create(listWithName: itemName)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "shoppingListCell", for: indexPath) as? ButtonTableViewCell else {return UITableViewCell()}
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            ListController.sharedInstance.remove(list: list)
...
//MARK: - Fetched Results Controller for Tableview
